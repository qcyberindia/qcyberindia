...
// /qfinera/learn/beginner/ (see the QFinance phased-implementation spec,
...
// /_archive/qfinera-sketchflow/ (excluded from tsc/eslint via tsconfig.json
...
export default function LegacyBeginnerRedirect() {
  redirect("/qfinera/learn/beginner");
}
